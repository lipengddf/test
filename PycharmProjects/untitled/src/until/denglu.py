...
class DS(unittest.TestCase):
    ...
    #     self.dr.find_element_by_id('com.qk.butterfly:id/et_login_phone').send_keys('18236910058')
    #     sleep(5)
    #     #向密码输入框内输入密码
    ...
    #     sleep(5)
        ...
        sleep(10)
        #点击搜索
        self.dr.find_element_by_id('com.qk.butterfly:id/v_search').click()
        sleep(3)
        #点击 < 键
        self.dr.find_element_by_id('com.qk.butterfly:id/v_search').click()
        sleep(3)
        #点击右上角房子
        self.dr.find_element_by_id('com.qk.butterfly:id/iv_live').click()
        sleep(3)
        self.dr.find_element_by_id('com.qk.butterfly:id/v_close').click()
        sleep(3)
        #单击陪玩
        self.dr.find_element_by_id('com.qk.butterfly:id/tv_tag2').click()
        sleep(3)
        #单击娱乐
        self.dr.find_element_by_id('com.qk.butterfly:id/tv_tag3').click()
        sleep(3)
        #单击电台
        self.dr.find_element_by_id('com.qk.butterfly:id/tv_tag4').click()
        sleep(3)
        #单击交友
        self.dr.find_element_by_id('com.qk.butterfly:id/tv_tag5').click()
        sleep(3)
        #单击点唱
        self.dr.find_element_by_id('com.qk.butterfly:id/tv_tag6').click()
        sleep(3)
        #单击聊天
        self.dr.find_element_by_id('com.qk.butterfly:id/tv_tag7').click()
        sleep(5)
        #单击热门
        self.dr.find_element_by_id('com.qk.butterfly:id/tv_tag1').click()
        sleep(3)

        self.dr.find_element_by_id('com.qk.butterfly:id/tv_home_name1').click()
        sleep(7)
        self.dr.find_element_by_id('com.qk.butterfly:id/v_close').click()
        sleep(10)
    #app退出登录
